...
setwd("C:/Users/Alejandro/Desktop/Bayes Course/ParameterEstimation/DataAnalysis")
...
samples = jags(data, inits=myinits, parameters,
	 			 model.file ="Correlation_1.txt", n.chains=1, n.iter=50000, 
...
# data panel:    
plot(x[,1],x[,2], type="p", pch=19, cex=1, xlab='Response Time', ylab='IQ')
# correlation panel:
