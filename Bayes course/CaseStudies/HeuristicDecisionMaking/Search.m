...
run_model = 0; % set 0 to load samples, or 1 to run WinBUGS
...
datastruct = struct('ns',ns,'nc',nc,'nq',nq,'m',m,'p',p,'y',y);
...
if ~run_model
    ...
    if ~sampler
        ...
        [samples, stats] = matbugs(datastruct, ...
            fullfile(pwd, 'Search.txt'), ...
            'init', init0, ...
            'nChains', nchains, ...
            'view', 1, 'nburnin', nburnin, 'nsamples', nsamples, ...
            'thin', nthin, 'DICstatus', 0, 'refreshrate',1, ...
            'monitorParams', {'gamma','s','ypred'}, ...
...
set(gca,'fontsize',16,'box','on','ticklength',[.0 .0],'xtick',[1 17 nq-6+1 nq],'ytick',[1 5:5:ns]);
