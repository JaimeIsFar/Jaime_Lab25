% One Sample Comparison of Means Order Restricted
clear;
...
if ~run_model
    load OneSampleOrderRestricted_1 samples stats
else
    if ~sampler
        % Use WinBUGS to Sample
        [samples, stats] = matbugs(datastruct, ...
            fullfile(pwd, 'OneSampleorderRestricted.txt'), ...
            'init', init0, ...
            'nChains', nchains, ...
        ...
        [samples, stats] = matjags( ...
            datastruct, ...
            fullfile(pwd, 'OneSampleOrderRestrictedJ.txt'), ...
            init0, ...
    ...
    save OneSampleOrderRestricted_1 samples stats
end;
...
set(gca,'fontsize',14);
crit = 0;
eps =.005;binsc = [-3+eps/2:eps:0];binse = [-3:eps:0];
