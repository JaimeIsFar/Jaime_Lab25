...
if ~run_model
    load GeurtsOrderRestricted samples stats
else
    if ~ sampler
        % Use WinBUGS to Sample
        [samples, stats] = matbugs(datastruct, ...
            fullfile(pwd, 'GeurtsOrderRestricted.txt'), ...
            'init', init0, ...
            'nChains', nchains, ...
        ...
        [samples, stats] = matjags( ...
            datastruct, ...
            fullfile(pwd, 'GeurtsOrderRestrictedJ.txt'), ...
            init0, ...
    ...
    save GeurtsOrderRestricted samples stats
end;

%% Analysis
crit = 0;
eps =.05;mineffect=0;maxeffect = 3;
