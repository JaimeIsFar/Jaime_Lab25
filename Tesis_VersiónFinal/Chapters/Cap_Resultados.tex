...
\begin{figure}[ph]
\centering
\includegraphics[width=0.33\textwidth]{Figures/F1_2} \includegraphics[width=0.33\textwidth]{Figures/F1_1} 
\includegraphics[width=0.33\textwidth]{Figures/F1_4} \includegraphics[width=0.33\textwidth]{Figures/F1_3} 
\includegraphics[width=0.33\textwidth]{Figures/F1_6} \includegraphics[width=0.33\textwidth]{Figures/F1_5} 
\includegraphics[width=0.33\textwidth]{Figures/F1_8} \includegraphics[width=0.33\textwidth]{Figures/F1_7} 
\decoRule
\caption[Exploración visual de la consistencia entre creencias y elecciones]{Comparación entre los números elegidos y las creencias promedio registradas por periodo. La línea de identidad representa la consistencia total. Los páneles izquierdos incluyen la multiplicación por $p$ y los derechos omiten dicha operación.}
...
\begin{table}[h]
\caption[Diferencias Normalizadas en el Subjuego 1 (prueba t de una muestra)]{\textbf{Diferencias Normalizadas en el Subjuego 1} Prueba t bayesiana de una sola muestra.}
\label{DN-S1-B}
\centering
...
\begin{table}[h]
\caption[Diferencias Normalizadas en el Subjuego 1, omitiendo la multiplicación por $p$ (prueba t de una muestra)]{\textbf{Diferencias Normalizadas en el Subjuego 1 omitiendo la multiplicación por p:} Prueba t bayesiana de una sola muestra.}
\label{DNnop-S1-B}
\centering
\begin{tabular}{l | c c | c}
\toprule
...
En general, a pesar de las diferencias en los métodos empleados para la explicitación de creencias, el presente estudio presenta hallazgos similares a los reportados por Lahav (\citeyear{Lahav}), al emplear el método propuesto para calcular las Diferencias Normalizadas entre las creencias y las elecciones de los participantes:
...
\begin{table}[h]
\caption[Diferencias Relativas en el Subjuego 1 (prueba t de una muestra)]{\textbf{Diferencias Relativas en el Subjuego 1} Prueba t bayesiana de una sola muestra.}
\label{DR-S1-B}
\centering
\begin{tabular}{l | c c | c}
\toprule
...
\begin{figure}[h]
\centering
\includegraphics[width=0.43\textwidth]{Figures/F4_1} & \includegraphics[width=0.43\textwidth]{Figures/F4_2} 
\includegraphics[width=0.43\textwidth]{Figures/F4_3} & \includegraphics[width=0.43\textwidth]{Figures/F4_4} 
\decoRule
...
\begin{table}[h]
\caption[Diferencias Relativas en el Subjuego 1, omitiendo la multiplicación por $p$ (prueba t de una muestra)]{\textbf{Diferencias Relativas en el Subjuego 1 sin la multiplicación por p} Prueba t bayesiana de una sola muestra.}
\label{DRnop-S1-B}
\centering
\begin{tabular}{l | c c | c}
\toprule
...
\begin{figure}[h]
\centering
\includegraphics[width=0.43\textwidth]{Figures/F5_1} & \includegraphics[width=0.43\textwidth]{Figures/F5_2} 
\includegraphics[width=0.43\textwidth]{Figures/F5_3} & \includegraphics[width=0.43\textwidth]{Figures/F5_4} 
\decoRule
...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{Figures/F6_1} & \includegraphics[width=0.35\textwidth]{Figures/F6_2} 
\includegraphics[width=0.35\textwidth]{Figures/F6_3} & \includegraphics[width=0.35\textwidth]{Figures/F6_4} 
\decoRule
\caption[Elecciones registradas en ensayos consecutivos]{Se presenta la relación entre los números elegidos en los cinco primeros periodos consecutivos jugados por los participantes A. Los primeros tres páneles ilustran la disminución de elecciones en el Subjuego 1, mientras que en el último panel, se observa el Efecto Reset.}
...
\begin{table}[h]
\caption[Prueba binomial bayesiana para evaluar la proporción de casos en que los participantes A aumentan y reducen su número elegido]{\textbf{Aumentos en los números elegidos en periodos consecutivos} Prueba binomial bayesiana.}
\label{Binom_Reset}
\centering
\begin{tabular}{l c | c c | c}
\toprule
%\tabhead{Groups} & \tabhead{Treatment X} & \tabhead{Treatment Y} \\
\textbf{Periodos} &  \textbf{Casos con aumento} & \textbf{Proporción} & \textbf{$BF_{10}$}\\
\midrule
1 vs 2 & 3 & 0.3 & 0.176\\
2 vs 3 & 4 & 0.4 & 0.243\\
3 vs 4 & 2 & 0.2 & 0.135\\
...
Las creencias y elecciones de los participantes en el Subjuego 2 fueron sometidos a los mismos análisis reportados para el Subjuego 1 en la \textbf{sección 4.1}: se computaron las Diferencias Normalizadas y las Diferencias Relativas, incluyendo y excluyendo la multiplicación por $p$. Pero en esta ocasión, se hizo una distinción entre la ejecución de los jugadores con experiencia (participantes A) y los jugadores que participaban en el juego por primera vez (participantes D y E).\\

\begin{figure}[ph]
\centering
\includegraphics[width=0.33\textwidth]{Figures/F10_1} & \includegraphics[width=0.33\textwidth]{Figures/F10_2} 
\includegraphics[width=0.33\textwidth]{Figures/F10_3} & \includegraphics[width=0.33\textwidth]{Figures/F10_4} 
\includegraphics[width=0.33\textwidth]{Figures/F10_5} & \includegraphics[width=0.33\textwidth]{Figures/F10_6} 
\includegraphics[width=0.33\textwidth]{Figures/F10_7} & \includegraphics[width=0.33\textwidth]{Figures/F10_8} 
\decoRule
...
\begin{table}[h]
\caption[Diferencias Normalizadas en el Subjuego 2; Participante A (Pruebas t de una muestra)]{\textbf{Diferencias Normalizadas en el Subjuego 2 (Participantes A)} Prueba t bayesiana de una sola muestra.}
\label{DN-S2-A-B}
\centering
\begin{tabular}{l | c c | c}
\toprule
...
\begin{table}[h]
\caption[Diferencias Normalizadas en el Subjuego 2; Participantes D y E (Pruebas t de una muestra)]{\textbf{Diferencias Normalizadas en el Subjuego 2 (Participantes D y E)} Prueba t bayesiana de una sola muestra.}
\label{DN-S2-DyE-B}
\centering
\begin{tabular}{l | c c | c}
\toprule
...
\begin{figure}[hp]
\centering
\includegraphics[width=0.9\textwidth]{Figures/Figuras_11} 
\includegraphics[width=0.9\textwidth]{Figures/Figuras_12} 
\decoRule
\caption[Evaluación de las Diferencias Normalizadas entre creencias y elecciones en los participantes D y E en el Subjuego 2 (Factor de Bayes)]{Como resultado de la evaluación de las Diferencias Normalizadas computadas para los participantes A, D y E en el Subjuego 2, se presenta la comparación entre las densidades de probabilidad de las distribuciones prior y posterior computadas por periodo, en el punto de no diferencias.}
\label{fig:DN_S2}
\end{figure}
...
\begin{table}[h]
\caption[Diferencias Normalizadas en el Subjuego 2 omitiendo la multiplicación por $p$; Participante A (Pruebas t de una muestra)]{\textbf{Diferencias Normalizadas en el Subjuego 2 (Participantes A)} Prueba t bayesiana de una muestra.}
\label{DNnop-S2-A-B}
\centering
\begin{tabular}{l | c c | c}
\toprule
...
Por otra parte, en el caso de los participantes sin experiencia (D y E) solo se encontraron diferencias significativas respecto de 0 en el último periodo (ver Tabla~\ref{DNnop-S2-DyE-B}), resultado que coincide con lo reportado en el Subjuego 1, sugiriendo nuevamente que los participantes incorporaron la multiplicación por $p$ (o comprendieron la tendencia del juego hacia el equilibrio)  sólo después de varias repeticiones. Así mismo, en la Figura~\ref{fig:DNop_S2} se presentan las distribuciones prior y posterior computadas con las pruebas t realizadas por cada periodo, para los participantes con y sin experiencia en sus reespectivos páneles.\\

\begin{table}[h]
\caption[Diferencias Normalizadas en el Subjuego 2, omitiendo la multiplicación por $p$; Participantes D y E (Pruebas t de una muestra)]{\textbf{Diferencias Normalizadas en el Subjuego 2 (Participantes D y E)} Prueba t bayesiana de una sola muestra.}
...
\begin{figure}[hp]
\centering
\includegraphics[width=0.9\textwidth]{Figures/Figuras_13} 
\includegraphics[width=0.9\textwidth]{Figures/Figuras_14} 
\decoRule
\caption[Evaluación de las Diferencias Normalizadas entre creencias y elecciones en los participantes D y E en el Subjuego 2 (Factor de Bayes)]{Como resultado de la evaluación de las Diferencias Normalizadas computadas sin la multiplicación por $p$ para los participantes A, D y E en el Subjuego 2, se presenta la comparación entre las distribuciones prior y posterior computadas por periodo, en el punto $\delta = 0$.}
\label{fig:DNop_S2}
\end{figure}
...
\begin{table}[h]
\caption[Diferencias Relativas en el Subjuego 2; Participantes A (Pruebas t de una muestra)]{\textbf{Diferencias Relativas en el Subjuego 2 (Participantes A)} Prueba t bayesiana de una muestra.}
\label{DR-S2-A-B}
\centering
\begin{tabular}{l | c c | c}
\toprule
...
\begin{table}[h]
\caption[Diferencias Relativas en el Subjuego 2; Participantes D y E (Pruebas t de una muestra)]{\textbf{Diferencias Relativas en el Subjuego 2 (Participantes D y E)} Prueba t bayesiana de una muestra.}
\label{DR-S2-DyE-B}
\centering
\begin{tabular}{l | c c | c}
\toprule
...
\end{table}
 ...
 Los resultados que se obtienen son muy similares a lo que se observa al utilizar el método de Diferencias Normalizadas: el participante A muestra ser consistente en los cuatro periodos y los participantes D y E son inconsistencias en los primeros tres. En la Figura~\ref{fig:DR_S2} se incluyen las distribuciones prior y posterior computadas como resultado de las pruebas t bayesianas realizadas por periodo, por cada tipo de participante.\\

%\begin{figure}[h]
%\centering
%\includegraphics[width=0.45\textwidth]{Figures/F15_1} & \includegraphics[width=0.45\textwidth]{Figures/F15_2} 
%\includegraphics[width=0.45\textwidth]{Figures/F15_3} & \includegraphics[width=0.45\textwidth]{Figures/F15_4} 
%\decoRule
...
%\begin{figure}[h]
%\centering
%\includegraphics[width=0.45\textwidth]{Figures/F16_1} & \includegraphics[width=0.45\textwidth]{Figures/F16_2} 
%\includegraphics[width=0.45\textwidth]{Figures/F16_3} & \includegraphics[width=0.45\textwidth]{Figures/F16_4} 
%\decoRule
...
\begin{table}[h]
\caption[Diferencias Relativas en el Subjuego 2, omitiendo la multiplicación por $p$; Participantes D y E (Pruebas t de una muestra)]{\textbf{Diferencias Relativas en el Subjuego 2 (Participantes D y E), omitiendo p} Prueba t bayesiana de una muestra.}
...
\begin{figure}[hp]
\centering
\includegraphics[width=0.9\textwidth]{Figures/Figuras_17} 
\includegraphics[width=0.9\textwidth]{Figures/Figuras_18} 
\decoRule
\caption[Evaluación de las Diferencias Normalizadas entre creencias y elecciones en los participantes D y E en el Subjuego 2 (Factor de Bayes)]{Como resultado de la evaluación de las Diferencias Relativas computadas para los participantes A, D y E sin la multiplicación  por $p$, se presenta la comparación entre las densidades de probabilidad de las distribuciones prior y posterior en el punto de no diferencia.}
\label{fig:DRnop_S2}
\end{figure}
...
\begin{figure}[hp]
\centering
\includegraphics[width=0.33\textwidth]{Figures/F19_1} 
\includegraphics[width=0.33\textwidth]{Figures/F19_3} 
\includegraphics[width=0.33\textwidth]{Figures/F19_5} 
\includegraphics[width=0.33\textwidth]{Figures/F19_7} 
\includegraphics[width=0.33\textwidth]{Figures/F19_9} 
\includegraphics[width=0.33\textwidth]{Figures/F19_11} 
\includegraphics[width=0.33\textwidth]{Figures/F19_13} 
\includegraphics[width=0.33\textwidth]{Figures/F19_15} 
\decoRule
...
\begin{figure}[hp]
\centering
\includegraphics[width=0.33\textwidth]{Figures/F19_2} 
\includegraphics[width=0.33\textwidth]{Figures/F19_4} 
\includegraphics[width=0.33\textwidth]{Figures/F19_6} 
\includegraphics[width=0.33\textwidth]{Figures/F19_8} 
\includegraphics[width=0.33\textwidth]{Figures/F19_10} 
\includegraphics[width=0.33\textwidth]{Figures/F19_12} 
\includegraphics[width=0.33\textwidth]{Figures/F19_14} 
\includegraphics[width=0.33\textwidth]{Figures/F19_16} 
\decoRule
